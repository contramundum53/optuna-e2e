...
try:
    study1.optimize(objective_with_inf_nan, n_trials=10)
...
try:
    study3.optimize(objective_with_inf_nan, n_trials=10)
except BaseException:
    pass
print("mssql")
...
try:
    study4.optimize(objective_with_inf_nan, n_trials=10)
except BaseException:
    pass
print("redis")
